...
function countMethod(items: IStatistics[]): MethodCounter {
  ...
  for (const item of items) {
    if (item.method === "GET") counter.GET += 1;
    else if (item.method === "HEAD") counter.HEAD += 1;
    else if (item.method === "POST") counter.POST += 1;
    else if (item.method === "PUT") counter.PUT += 1;
    else if (item.method === "DELETE") counter.DELETE += 1;
    else if (item.method === "CONNECT") counter.CONNECT += 1;
    else if (item.method === "OPTIONS") counter.OPTIONS += 1;
    else if (item.method === "TRACE") counter.TRACE += 1;
    else if (item.method === "PATCH") counter.PATCH += 1;
  }
